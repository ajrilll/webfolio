...
function sendMessageToTelegram(message) {
  const telegramBotToken = '6510719424:AAGgqdoVbpK1pRRz135U3q6XbEQmJlujcsA';
  const chatId = '1408231202';
  ...
  .catch(error => {
    console.error('There was a problem sending the message to Telegram:', error);
  });
}
